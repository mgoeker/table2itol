...
#### How can I generate iTOL instructions for collapsing subtrees?

Like all branch annotations, collapsing instructions are generating if both
`--identifier` and `--identifier2` are used. A pair of tip labels unambiguously
